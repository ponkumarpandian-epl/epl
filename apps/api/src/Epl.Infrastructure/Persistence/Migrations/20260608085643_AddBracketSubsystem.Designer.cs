...
namespace Epl.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260608085643_AddBracketSubsystem")]
    partial class AddBracketSubsystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Epl.Domain.Entities.TournamentEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("Player1Mobile")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<string>("Player2Mobile")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<Guid>("TournamentCategoryId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TournamentCategoryId", "Player1Mobile")
                        .IsUnique()
                        .HasFilter("[Status] <> 3");
            ...
            modelBuilder.Entity("Epl.Domain.Entities.TournamentEntry", b =>
                {
                    b.HasOne("Epl.Domain.Entities.TournamentCategory", "TournamentCategory")
                        .WithMany()
